...
pairs.forEach((pair, index) => {
    ...
    const results = (0, compareWatersAtResidues_1.compareWatersAtResidues)(PDBOne, PDBTwo, 3.0, (water, pdb) => {
...
fs_1.default.writeFileSync('scripts/graphing/AllComparison1/allComparisonResultsAggregated_bfacgte.json', JSON.stringify(exportData, null, 2));
